...
-----------------------------------------------------------------------
Put the script you would like to obfuscate
-----------------------------------------------------------------------
end

print("--// This script was obfuscated with JANXYYI OBFUSCATOR"..version.." by NoLifeRobloxHacker on github.")
print()


local IIlIlIIIIllllIllIllllIlIlllIIIllIll = function(str)
		local Return = "local llIIlIlIIllllIlIlIlIIlIlIlIllllIllI = {"
		local LengthDiv = 120
		for i = 1, str:len() do
			if i == str:len() then
...
IIlIlIIIIllllIllIllllIlIlllIIIllIll(string.dump(IllIllIlIlIIlIIlIIlllIlllIllllIllll))
